...
final class WorkspaceWatcherTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        dir = FileManager.default.temporaryDirectory
            .appendingPathComponent("mieli-watcher-\(UUID().uuidString)", isDirectory: true)
    ...
    func testIgnoresInternalAndAttachmentPaths() {
        XCTAssertTrue(WorkspaceWatcher.isIgnoredPath(".mieli/index.sqlite"))
        XCTAssertTrue(WorkspaceWatcher.isIgnoredPath(".muisti/index.sqlite"))
    ...
    func testSnapshotOnlyCollectsMarkdown() throws {
        ...
        try write("图片.png")
        try write("工作/c.md")
        try write(".mieli/idx.sqlite") // ignored dir
        try write(".muisti/idx.sqlite") // legacy ignored dir
        try write(".minne/idx.sqlite") // legacy ignored dir
