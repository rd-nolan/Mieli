...
final class AppLanguage {
    ...
    static let preferenceKey = "Muisti.AppLanguage"
    private static let legacyPreferenceKey = "Minne.AppLanguage"
    private static let legacyBundleIdentifier = "com.valcub.app.Minne"
